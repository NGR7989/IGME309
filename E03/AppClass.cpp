...
{
	m_uShaderProgramID = LoadShaders("Shaders//BasicColor.vs", "Shaders//BasicColorInverter_E03.fs");
...
{
	glm::vec3 normalColors = glm::vec3(1.0f, 1.0f, 1.0f);
...
void AppClass::Display(void)
{
	...
	GLuint IsInverted = glGetUniformLocation(m_uShaderProgramID, "IsInverted");
	glUniform1i(IsInverted, isInverted);
